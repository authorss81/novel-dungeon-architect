...
- **OT-07:** Will Marek accept that another person can hold part of the load, or repeat the One-Seat pattern under a kinder name? Batch 0002 shows him accepting named resident limits, but the larger habit is not settled.
- **OT-12:** Marek and Nera move from professional antagonism toward chosen partnership through disagreement, shared work, and consequences; no instant attraction or magical bond. In Batch 0002 Nera corrects his air assumptions and Marek accepts that her stop condition governs the air plan. The relationship must stay slow and must not be accelerated by the pressure events.
- **OT-14:** Iven's maintenance signature has now produced a suspended guild witness bond. The visible cost is real, but he is not yet a full defector; future guild work, replacement parts, and records remain contested.
- **OT-17:** The Hearthholds must decide what routes, records, structures, and maintenance are public rather than owned by the first competent builder. The interim sheet is evidence of that decision beginning, not its completion.
...
These are canon from `outline/series.md` and `outline/ending.md`. They must stay stable and unforced, and they are not work owed by the next batch.

- **OT-01:** Why does the Lattice keep rebuilding rooms that resemble human homes, and who or what keeps trying to make the refuge habitable? Evidence so far is domestic use, school-refuge proportions, a clinic/school corner, evacuation markings, and local stair history — evidence of use, not a complete history.
